...
var G__48236 = new_next_nonws_QMARK_;
index = G__48234;
skip_to_right_QMARK_ = G__48235;
next_nonws_QMARK_ = G__48236;
continue;
}
}
break;
...
var G__48237 = zprint.focus.next_ssv(ssv,index);
var G__48238 = (moves - (1));
index = G__48237;
moves = G__48238;
continue;
}
...
var G__48242 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__48243 = cljs.core.next(nwp);
idx = G__48242;
nwp = G__48243;
continue;
}
...
})())?(function (){var fexpr__48227 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return fexpr__48227(ssv_next);
