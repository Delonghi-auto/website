...
return [(function (){var pred__47056 = cljs.core.instance_QMARK_;
var expr__47057 = reactive_val;
if(cljs.core.truth_((pred__47056.cljs$core$IFn$_invoke$arity$2 ? pred__47056.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__47057) : pred__47056.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__47057)))){
return "ra";
} else {
if(cljs.core.truth_((pred__47056.cljs$core$IFn$_invoke$arity$2 ? pred__47056.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__47057) : pred__47056.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__47057)))){
return "rc";
} else {
if(cljs.core.truth_((pred__47056.cljs$core$IFn$_invoke$arity$2 ? pred__47056.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__47057) : pred__47056.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__47057)))){
return "rx";
} else {
if(cljs.core.truth_((pred__47056.cljs$core$IFn$_invoke$arity$2 ? pred__47056.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__47057) : pred__47056.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__47057)))){
return "tr";
} else {
return "other";
}
