...
if((c === "\n")){
var G__49865 = escape_QMARK_;
var G__49866 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__49865;
lines = G__49866;
continue;
} else {
buf.append(c);

var G__49867 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__49868 = lines;
escape_QMARK_ = G__49867;
lines = G__49868;
continue;
...
var G__49862 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__49862) : rewrite_clj.node.string_node.call(null,G__49862));
});
...
var G__49863 = cljs.core.re_pattern(regex);
var G__49864 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__49863,G__49864) : rewrite_clj.node.token_node.call(null,G__49863,G__49864));
});
