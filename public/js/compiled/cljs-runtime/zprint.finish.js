...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48229_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48229_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48229_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48230){
var vec__48231 = p__48230;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48231,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48231,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48239,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48240__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48240__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48240__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48246 = (function (){var or__4185__auto__ = color;
...
var fexpr__48245 = (function (){var G__48247 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48247) : style_map.call(null,G__48247));
})();
return (fexpr__48245.cljs$core$IFn$_invoke$arity$1 ? fexpr__48245.cljs$core$IFn$_invoke$arity$1(G__48246) : fexpr__48245.call(null,G__48246));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48248){
var vec__48249 = p__48248;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48249,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48249,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48249,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48252){
var vec__48253 = p__48252;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48253,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48253,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48253,(2),null);
...
var vec__48259 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48259,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48259,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48259,(2),null);
...
var G__48329 = cljs.core.next(remaining_cvec);
var G__48330 = new_idx;
var G__48331 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48329;
idx = G__48330;
out = G__48331;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48271,cursor_vec){
var vec__48272 = p__48271;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48272,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48272,(1),null);
var focus_vec = vec__48272;
...
var vec__48275 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48275,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48275,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48281){
var vec__48282 = p__48281;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48282,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48282,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48291,existing_count){
var vec__48292 = p__48291;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48292,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48292,(1),null);
...
return cljs.core.filterv((function (p1__48286_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48286_SHARP_))));
...
var vec__48302 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48302,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48302,(1),null);
var cvec_element = vec__48302;
if((cvec_element == null)){
var G__48341 = cljs.core.next(cvec_nl);
var G__48342 = (idx + (1));
var G__48343 = start;
var G__48344 = out;
cvec_nl = G__48341;
...
var G__48345 = cljs.core.next(cvec_nl);
var G__48346 = (idx + (1));
var G__48347 = idx;
var G__48348 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48345;
idx = G__48346;
start = G__48347;
out = G__48348;
...
var G__48349 = cljs.core.next(cvec_nl);
var G__48350 = (idx + (1));
var G__48351 = (idx + (1));
var G__48352 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48349;
idx = G__48350;
start = G__48351;
out = G__48352;
...
var G__48353 = cljs.core.next(cvec_nl);
var G__48354 = (idx + (1));
var G__48355 = idx;
var G__48356 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__48353;
idx = G__48354;
start = G__48355;
out = G__48356;
...
var G__48357 = cljs.core.next(cvec_nl);
var G__48358 = (idx + (1));
var G__48359 = start;
var G__48360 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48357;
idx = G__48358;
start = G__48359;
out = G__48360;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48306_SHARP_,p2__48305_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48305_SHARP_)){
return cljs.core.reduced(p1__48306_SHARP_);
} else {
return (p1__48306_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48308,p__48309){
var vec__48310 = p__48308;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48310,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48310,(1),null);
var vec__48313 = p__48309;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48313,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48313,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48318,cvec,focus_vec){
...
var options = map__48319__$1;
var map__48320 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48319__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48320__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48320__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48320__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48317_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48317_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
