...
var vec__51458 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__51463 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51463,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51463,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51458,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51458,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__51466){
var vec__51467 = p__51466;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51467,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51467,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51470,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51470,(1),null);
...
var vec__51474 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(2),null);
var vec__51477 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51477,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51477,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51477,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__51481){
var vec__51487 = p__51481;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51487,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51487,(1),null);
...
var len__4789__auto___51535 = arguments.length;
var i__4790__auto___51536 = (0);
while(true){
if((i__4790__auto___51536 < len__4789__auto___51535)){
args__4795__auto__.push((arguments[i__4790__auto___51536]));

var G__51537 = (i__4790__auto___51536 + (1));
i__4790__auto___51536 = G__51537;
continue;
} else {
}
break;
...
var vec__51494 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51494,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51494,(1),null);
...
var G__51497 = zprint.core.parse_string_all_options(rest_options);
var G__51498 = zprint.core.zprint_str_internal;
var G__51499 = ":parse-string-all? call";
var G__51500 = (function (){var G__51501 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51501) : zprint.zutil.edn_STAR_.call(null,G__51501));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__51497,G__51498,G__51499,G__51500) : zprint.core.process_multiple_forms.call(null,G__51497,G__51498,G__51499,G__51500));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__51502 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51502,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51502,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq51490){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51491,G__51492,seq51490__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51541 = arguments.length;
var i__4790__auto___51542 = (0);
while(true){
if((i__4790__auto___51542 < len__4789__auto___51541)){
args__4795__auto__.push((arguments[i__4790__auto___51542]));

var G__51543 = (i__4790__auto___51542 + (1));
i__4790__auto___51542 = G__51543;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq51507){
var G__51508 = cljs.core.first(seq51507);
var seq51507__$1 = cljs.core.next(seq51507);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51508,seq51507__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51544 = arguments.length;
var i__4790__auto___51545 = (0);
while(true){
if((i__4790__auto___51545 < len__4789__auto___51544)){
args__4795__auto__.push((arguments[i__4790__auto___51545]));

var G__51546 = (i__4790__auto___51545 + (1));
i__4790__auto___51545 = G__51546;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq51509){
var G__51510 = cljs.core.first(seq51509);
var seq51509__$1 = cljs.core.next(seq51509);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51510,seq51509__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51547 = arguments.length;
var i__4790__auto___51548 = (0);
while(true){
if((i__4790__auto___51548 < len__4789__auto___51547)){
args__4795__auto__.push((arguments[i__4790__auto___51548]));

var G__51549 = (i__4790__auto___51548 + (1));
i__4790__auto___51548 = G__51549;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq51511){
var G__51512 = cljs.core.first(seq51511);
var seq51511__$1 = cljs.core.next(seq51511);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51512,seq51511__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51550 = arguments.length;
var i__4790__auto___51551 = (0);
while(true){
if((i__4790__auto___51551 < len__4789__auto___51550)){
args__4795__auto__.push((arguments[i__4790__auto___51551]));

var G__51552 = (i__4790__auto___51551 + (1));
i__4790__auto___51551 = G__51552;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq51513){
var G__51514 = cljs.core.first(seq51513);
var seq51513__$1 = cljs.core.next(seq51513);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51514,seq51513__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__51516,form){
var vec__51517 = p__51516;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51517,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51517,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51517,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51517,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__51520 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51520,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51520,(1),null);
...
var forms = (function (){var G__51526 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51526) : zprint.zutil.edn_STAR_.call(null,G__51526));
})();
