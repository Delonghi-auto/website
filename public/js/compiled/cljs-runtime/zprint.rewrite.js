...
var G__50331 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__50331;
continue;
} else {
var G__50332 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__50332;
continue;
}
} else {
var G__50333 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__50333;
continue;
}
}
...
var G__50315 = zloc;
var G__50316 = (function (){var G__50317 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__50318 = zloc;
var G__50318__$1 = (((G__50318 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__50318) : rewrite_clj.zip.node.call(null,G__50318)));
if((G__50318__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50318__$1) : zprint.zutil.edn_STAR_.call(null,G__50318__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__50317) : rewrite_clj.zip.root.call(null,G__50317));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__50315,G__50316) : rewrite_clj.zip.replace.call(null,G__50315,G__50316));
});
/**
...
var G__50336 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__50336;
continue;
}
break;
...
var G__50337 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__50338 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__50337;
out = G__50338;
continue;
} else {
...
var G__50341 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__50342 = cljs.core.next(new_loc);
var G__50343 = replaced_loc;
nloc = G__50341;
new_loc = G__50342;
last_loc = G__50343;
continue;
