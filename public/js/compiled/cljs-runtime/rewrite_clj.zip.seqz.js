...
var G__50114 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__50114__$1 = (((G__50114 == null))?null:cljs.core.iterate((function (loc){
...
var G__50114__$2 = (((G__50114__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50114__$1));
var G__50114__$3 = (((G__50114__$2 == null))?null:cljs.core.last(G__50114__$2));
if((G__50114__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__50114__$3);
}
} else {
return zloc;
}
...
var G__50117 = rewrite_clj.zip.move.right(v);
var G__50118 = rewrite_clj.zip.move.up(v);
loc = G__50117;
parent = G__50118;
continue;
} else {
var G__50119 = rewrite_clj.zip.move.right(v0);
var G__50120 = parent;
loc = G__50119;
parent = G__50120;
continue;
...
var G__50121 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__50122 = rewrite_clj.zip.move.up(v);
loc = G__50121;
parent = G__50122;
continue;
} else {
var G__50123 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__50124 = parent;
loc = G__50123;
parent = G__50124;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__50115 = zloc;
var G__50115__$1 = (((G__50115 == null))?null:rewrite_clj.zip.move.down(G__50115));
var G__50115__$2 = (((G__50115__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__50115__$1,k));
if((G__50115__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__50115__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__50116 = rewrite_clj.zip.move.down(zloc);
var G__50116__$1 = (((G__50116 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__50116));
if((G__50116__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50116__$1);
}
})(),k);
}
});
