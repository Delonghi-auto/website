...
var G__53027 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","load-epoch","epochs/load-epoch",166872985),id], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53027) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,G__53027));
...
var all_events = cljs.core.deref((function (){var G__53028 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","all-events-by-id","epochs/all-events-by-id",-1225664812)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__53028) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.call(null,G__53028));
})());
var current_id = cljs.core.deref((function (){var G__53029 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__53029) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.call(null,G__53029));
})());
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4582__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__53030(s__53031){
...
var c__4580__auto__ = cljs.core.chunk_first(s__53031__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__53033 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__53032 = (0);
while(true){
if((i__53032 < size__4581__auto__)){
var vec__53034 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__53032);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53034,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53034,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__53033,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__53040 = (i__53032 + (1));
i__53032 = G__53040;
continue;
} else {
var G__53041 = (i__53032 + (1));
i__53032 = G__53041;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53033),day8$re_frame_10x$view$history$render_$_iter__53030(cljs.core.chunk_rest(s__53031__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53033),null);
}
} else {
var vec__53037 = cljs.core.first(s__53031__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53037,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53037,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__53030(cljs.core.rest(s__53031__$2)));
} else {
var G__53042 = cljs.core.rest(s__53031__$2);
s__53031__$1 = G__53042;
continue;
}
}
} else {
