...
var G__43602 = devtools.prefs.pref(v);
v = G__43602;
continue;
} else {
return v;
...
}catch (e43576){var _e__40590__auto__ = e43576;
return false;
}})();
...
}catch (e43583){var _e__40590__auto__ = e43583;
return false;
}})();
...
}catch (e43585){var _e__40590__auto__ = e43585;
return false;
}}
}
});
...
var vec__43595 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43595,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43595,(1),null);
...
return cljs.core.some((function (p1__43600_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43600_SHARP_);
}),template);
});
