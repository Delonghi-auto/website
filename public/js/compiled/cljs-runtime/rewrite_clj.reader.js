...
var len__4789__auto___49849 = arguments.length;
var i__4790__auto___49850 = (0);
while(true){
if((i__4790__auto___49850 < len__4789__auto___49849)){
args__4795__auto__.push((arguments[i__4790__auto___49850]));

var G__49851 = (i__4790__auto___49850 + (1));
i__4790__auto___49850 = G__49851;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq49843){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49844,G__49845,seq49843__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__49848_SHARP_){
return (((p1__49848_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__49848_SHARP_)));
...
var G__49860 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__49861 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__49860;
vs = G__49861;
continue;
} else {
