...
var syms = (function (){var iter__4582__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__49667(s__49668){
...
var c__4580__auto__ = cljs.core.chunk_first(s__49668__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__49670 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__49669 = (0);
while(true){
if((i__49669 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__49669);
...
cljs.core.chunk_append(b__49670,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__49728 = (i__49669 + (1));
i__49669 = G__49728;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49670),rewrite_clj$node$fn$fn_walk_$_iter__49667(cljs.core.chunk_rest(s__49668__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49670),null);
}
} else {
var i = cljs.core.first(s__49668__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__49667(cljs.core.rest(s__49668__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__49666_SHARP_){
var or__4185__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__49666_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k49674,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49674,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__49679){
var vec__49680 = p__49679;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49680,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49680,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49673){
var self__ = this;
var G__49673__$1 = this;
return (new cljs.core.RecordIter((0),G__49673__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__49688 = (function (coll__4436__auto__){
return (-1740346885 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__49688(this__4435__auto____$1);
})();
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49675,other49676){
var self__ = this;
var this49675__$1 = this;
return (((!((other49676 == null)))) && ((this49675__$1.constructor === other49676.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49675__$1.children,other49676.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49675__$1.__extmap,other49676.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__49673){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__49694 = cljs.core.keyword_identical_QMARK_;
var expr__49695 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__49697 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__49698 = expr__49695;
return (pred__49694.cljs$core$IFn$_invoke$arity$2 ? pred__49694.cljs$core$IFn$_invoke$arity$2(G__49697,G__49698) : pred__49694.call(null,G__49697,G__49698));
})())){
return (new rewrite_clj.node.fn.FnNode(G__49673,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__49673),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__49673){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__49673,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__49677){
var extmap__4478__auto__ = (function (){var G__49716 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49677,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__49677)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49716);
} else {
return G__49716;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49677),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
