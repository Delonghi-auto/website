...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__50033,k,f){
var vec__50034 = p__50033;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50034,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50034,(1),null);
var loc = vec__50034;
...
var G__50069 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50069;
continue;
}
break;
...
var G__50070 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50070;
continue;
} else {
return zloc__$1;
...
var G__50071 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50071;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50043){
var vec__50044 = p__50043;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50044,(0),null);
var map__50047 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50044,(1),null);
...
var path = map__50047__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50047__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__50044;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50051){
...
var path = map__50055__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50055__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50052;
if(cljs.core.seq(r)){
...
var vec__50060 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50060,(0),null);
var map__50063 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50060,(1),null);
...
var path = map__50063__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50063__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50063__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50063__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50063__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
