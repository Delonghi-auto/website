...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__48062){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48063__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48063__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48063__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48063__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48063__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__48075){
var vec__48076 = p__48075;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48076,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48076,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48074_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__48074_SHARP_,/:/);
...
var previous_config__48030__auto__ = devtools.prefs.get_prefs();
var prefs__48031__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__48031__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__48031__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__48031__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__48030__auto__);
}}));

(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq48086){
var G__48087 = cljs.core.first(seq48086);
var seq48086__$1 = cljs.core.next(seq48086);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48087,seq48086__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___48115 = arguments.length;
var i__4790__auto___48116 = (0);
while(true){
if((i__4790__auto___48116 < len__4789__auto___48115)){
args__4795__auto__.push((arguments[i__4790__auto___48116]));

var G__48117 = (i__4790__auto___48116 + (1));
i__4790__auto___48116 = G__48117;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq48088){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48088));
}));
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq48089){
var self__4777__auto__ = this;
...
var args__4795__auto__ = [];
var len__4789__auto___48121 = arguments.length;
var i__4790__auto___48122 = (0);
while(true){
if((i__4790__auto___48122 < len__4789__auto___48121)){
args__4795__auto__.push((arguments[i__4790__auto___48122]));

var G__48123 = (i__4790__auto___48122 + (1));
i__4790__auto___48122 = G__48123;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq48090){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48090));
}));
...
var expanded_QMARK_ = (function (){var G__48091 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__48091) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.call(null,G__48091));
})();
...
var G__48092 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48092) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,G__48092));
...
})())?(function (){var G__48093 = day8.re_frame_10x.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__48094 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__48093,G__48094) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__48093,G__48094));
})():(function (){var G__48095 = day8.re_frame_10x.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__48096 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"header","header",119441134));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__48095,G__48096) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__48095,G__48096));
})())], null);
});
});
/**
...
var tag_name = first__48099;
var first__48099__$1 = cljs.core.first(seq__48098__$1);
var seq__48098__$2 = cljs.core.next(seq__48098__$1);
var attributes = first__48099__$1;
var children = seq__48098__$2;
...
var G__48100 = child;
var G__48101 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__48100,G__48101) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__48100,G__48101));
})),children);
} else {
...
var expanded_QMARK_ = (function (){var G__48102 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__48102) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.call(null,G__48102));
})();
...
var G__48103 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48103) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,G__48103));
...
var args__4795__auto__ = [];
var len__4789__auto___48126 = arguments.length;
var i__4790__auto___48127 = (0);
while(true){
if((i__4790__auto___48127 < len__4789__auto___48126)){
args__4795__auto__.push((arguments[i__4790__auto___48127]));

var G__48128 = (i__4790__auto___48127 + (1));
i__4790__auto___48127 = G__48128;
continue;
} else {
}
break;
...
(day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__48107){
var vec__48108 = p__48107;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48108,(0),null);
var expanded_QMARK_ = day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (data__$1){
...
/** @this {Function} */
(day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq48104){
var G__48105 = cljs.core.first(seq48104);
var seq48104__$1 = cljs.core.next(seq48104);
var G__48106 = cljs.core.first(seq48104__$1);
var seq48104__$2 = cljs.core.next(seq48104__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48105,G__48106,seq48104__$2);
}));
