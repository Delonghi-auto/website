...
var G__49818_49832 = rewrite_clj.node.protocols.coerce;
var G__49819_49833 = "object";
var G__49820_49834 = (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});
goog.object.set(G__49818_49832,G__49819_49833,G__49820_49834);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__49821_49835 = rewrite_clj.node.protocols.coerce;
var G__49822_49836 = "number";
var G__49823_49837 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});
goog.object.set(G__49821_49835,G__49822_49836,G__49823_49837);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__49824_49838 = rewrite_clj.node.protocols.coerce;
var G__49825_49839 = "string";
var G__49826_49840 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});
goog.object.set(G__49824_49838,G__49825_49839,G__49826_49840);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__49827 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__49827) : f.call(null,G__49827));
})(),sq);
});
...
var comma_49841 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_49842 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__49828){
var vec__49829 = p__49828;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49829,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49829,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_49842,rewrite_clj.node.protocols.coerce(v),comma_49841], null);
